...
$lot = utf8_decode($lot);
	...
	abmImpago($lat,$lot,$fecha,$motivo,$cod_cobrador,$cod_cliente);
...
function abmImpago($lat,$lot,$fecha,$motivo,$cod_cobrador,$cod_cliente)
{


$mysqli=conectar_al_servidor(); 

$consulta="Insert into visitascliente (Motivo, cod_clienteFK, cod_cobradorFK,fechaCompro,lat,lot)
values('$motivo',$cod_cliente,$cod_cobrador,'$fecha','$lat','$lot')";
