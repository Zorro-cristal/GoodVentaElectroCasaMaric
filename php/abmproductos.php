...
abm($CodProveedorFK,$tipoproducto,$cod_producto,$codBarras,$cod_categoriaFK,$cod_marcasFK,$cod_ImpuestoFK,$porcentaje,$nombre_producto,$descripcion_producto,$unidad_producto,$precio_producto,$precio_compra,$cod_localFK,$comision,$stock_producto,$estado,$operacion);
 ...
 if($operacion=="buscardetallespreciossolicitud"){
	...
	$precio=buscardetallespreciossolicitud($cod_productoSolicitud,$cantidadCuotaSolicitud);
...
<td id='td_id' style='display:none'>".$cod_producto."</td>
<td  id='' style='width:50%'>".$local."</td>
<td  id='' style='width:50%'>".$stock_producto."</td>
</tr>
</table>";
...
$sql= "select precio,Porcentaje,descripcion,cod_producto,iddetallesprecio,comision,Cuota
 from  detallesprecio 
where cod_producto='$buscar' and Cuota='$cuota'  order by Cuota asc ";
