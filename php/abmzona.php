...
if($nombre!=""){
	$condicionnombre=" and nombre  like '%".$nombre."%'";
		...
		$sql= "Select idzona,nombre,estado,(SELECT usu FROM cobrador WHERE cod_cobrador = cod_cobradorFK LIMIT 1) as cobrador,
...
function buscaroption($cod_cobradorFK)
{
	$mysqli=conectar_al_servidor();
	
		$sql= "Select * from zona where estado='Activo' and cod_cobradorFK =  '$cod_cobradorFK'";
		 $pagina="<option  value='' >SELECCIONAR</option>";  
