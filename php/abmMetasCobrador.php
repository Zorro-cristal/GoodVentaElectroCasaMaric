...
buscarMetasCobrador($tipoPago, $tipoCuota , $fecha1,$fecha2,$cobrador,$local,$tipo);
}	
...
function buscarMetasCobrador($tipoPago, $tipoCuota , $fecha1,$fecha2,$cobrador,$local,$tipo)
{
	$mysqli=conectar_al_servidor();
	  ...
	  while ($valor= mysqli_fetch_assoc($result))
	  {
			  ...
			  $TotalCobranza= $TotalCobranza + $TotalCobrado[0];
				...
				<h3>".$cobrador."</h3>
                    <div class='status'>
                        <div >
                            <div  class='imgPerfil' style='background-image: url(".$url_img.")'></div>
                        </div>
						<div class='info'>
...
$informacion =array("1" => "exito","2" => $pagina,"3" => $nroRegistro,"4" =>number_format($TotalCobranza,'0',',','.'));
echo json_encode($informacion);	
exit;
