...
$sql= "select pr.cod_persona,pr.nombre_persona,pr.apellido_persona,cl.rut_cliente,pd.cantidad,
...
pro.precio_producto
 ...
 where concat(pr.nombre_persona,' ',pr.apellido_persona,' ',cl.rut_cliente) like ? limit 300 ";
