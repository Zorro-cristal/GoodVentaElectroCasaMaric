...
+"<p class='pTituloC'><b>Importe:</b>&nbsp&nbsp </p>"
+"</td>"
+"</tr>"
+"</table>"
+"<br>"
...
+"<br>"
+"<br>"
+"A todos los efectos legales se conviene expresamente la jurisdicción de los Tribunales Ordinarios de la República del Paraguay. Se fija domicilio real y especial en los lugares señalados más abajo, donde se tendrán por válidas, como personales las notificaciones que llegaren a practicarse, aun cuando fueren hechas por telegrama colacionado.---------"
+"</p>"
+"</div>"
+"<br>"
+"<br>"
...
document.getElementById("tbDatosImpresiones").innerHTML=document.getElementById("table_comision_productosStock").innerHTML
}
...
// function ReImprimirDivTickeFacturaPago(Fecha,Cajero,CuotasNro,Pagado,DiasAtrazado,NombreCliente,CiCliente,NroRecibo,tipoventa,totalInteres,deudaActual,totalpagado,totaldescuento,TotalVenta,InteresActual,deudaActualsininteres,NrofacturaVenta,fechaVenta){
	
	// if(CiCliente!=""){
		// CiCliente=separadordemilesnumero(CiCliente)
	// }
...
// });		
	...
	// var FechaPago = new Date(Fecha);
	
	// var dia = FechaPago.getDate()
	// if (dia < 10) {
		// dia = "0" + dia;
	// }
	...
	// if (mes < 10) {
		// mes = "0" + mes;
	// }
	// var NuevaFecha= dia + "/" + mes + "/" +  FechaPago.getFullYear();
	
// pagina="<br><div style='background-color:#fff;'>"
// +"<center>"

// +"<div class='divTicket' style='width: 90%; border-radius: 10px;height: 450px;' > "

// +"<div style='width: 100%;'  ><table style='width: 100%;' ><tr>"
// +"<td style='width: 40%;' >"
// +"<div > <center> <img src='/GoodVentaElectroCasaMaric/iconos/LogoOferta.jpg' style=' height: 120px;  width: 350px; ' />"
// +"</center></div>"
// +"</td>"

// +"<td style='width: 60%;' >"
// +"<div ><p class='pTituloTicket1' style='font-size:18px;margin-left: 30px;' ><b style='border-bottom: solid 1px;'>RECIBO DE DINERO</b></p>"
// +"<table class='tableTicket' style='text-align: end;'> <tr>"
// +"<td style='width:100%;font-size: 12px;  font-weight: 800;'><b>Nro : "+NroRecibo+"</b></td>"
// +"</tr> </table>"

// +"<table class='tableTicket' style='text-align: end;'> <tr>"
// +"<td style='width:60%'></td>  <td style='width:40%'><div style='border: 1px solid; border-radius: 10px;font-size: 15px; padding: 10px;' ><b>Gs: &nbsp;&nbsp;</b> <b style='background: #fbd4b2d1;margin: 10px;'>"+Pagado+"</b> </div></td>"
// +"</tr> </table>"
// +"</div>"
// +"</td>"
...
// +"<br>"
// +"<div class='divSeparadorTicket' style='margin-bottom:5px'></div>"
// +"<div style='text-align: end;margin-right: 90px; font-weight: 500;'> <b style=''>CORONEL OVIEDO ,&nbsp;  </b>  "+NuevaFecha+" </div>"
// +"<br>"
// +"<div style='text-align: left;font-family: sans-serif;' > <b style='margin-left: 50px;font-weight: 500;'>Recibi de :&nbsp;  </b>  <b style='border-bottom: dashed 1px;'>"+CiCliente+"&nbsp;&nbsp;&nbsp;&nbsp;"+NombreCliente+" &nbsp;&nbsp;&nbsp;</b> </div>"

// +"<br>"

// +"<div style='text-align: left;font-family: sans-serif;' > <b style='margin-left: 50px;font-weight: 500;' >La suma de :&nbsp;&nbsp;&nbsp;  </b> <b style='background: #fbd4b2d1; display: inline-block; border-radius: 3px;border-bottom: dashed 1px;'> "+totaletrasRecibo+" &nbsp;&nbsp;&nbsp;</b> </div>"

// +"<br>"

// +"<div style='text-align: left;font-family: sans-serif;' > <b style='margin-left: 50px;font-weight: 500;' >En Concepto de: </b> "
// +"<b style='border-bottom: dashed 1px;'> Pago de cuotas según detalle "+paginaticket+" &nbsp;&nbsp;&nbsp;</b>  </div>"

// +"<br><br>"

// +"<table  style='width:100%'>"
// +"<tr>"
// +"<td style='width:50%;text-align: center; '><b>_ _ _ _ _ _ _ _ _ _ _ _ _ </b></td>"
// +"<td style='width:50%;text-align: center; '><b>_ _ _ _ _ _ _ _ _ _ _ _ _</b></td>"
// +"</tr>"

// +"<tr>"
// +"<td style='width:50%;text-align: center;font-family: sans-serif;'><b>Aclaración</b></td>"
// +"<td style='width:50%;text-align: center;font-family: sans-serif;'><b>Firma</b></td>"
// +"</tr>"
// +"</table>"
...
// +"<td style='width:50%;text-align: end;'><b >Fecha de Venta:</b></td> <td style='width:50%;text-align: end;'><b> "+fechaVenta+" </b></td> </tr> </table>"
// +"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr>"
// +"<td style='width:50%;text-align: end;'><b>Nro Factura:</b></td> <td style='width:50%;text-align: end;'><b> "+NrofacturaVenta+" </b></td> </tr> </table> "

// +"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr>"
// +"<td style='width:50%;text-align: end;'><b>Total Factura:</b></td> <td style='width:50%;text-align: end;'><b> "+TotalVenta+" Gs. </b></td> </tr> </table> "

// +"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr> "
// +"<td style='width:50%;text-align: end;'><b>Total Pagado:</b></td> <td style='width:50%;text-align: end;'><b> "+totalpagado+" Gs. </b></td> </tr> </table>"
// +"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr>"
// +"<td style='width:50%;text-align: end;'><b>Saldo Actual:</b></td> <td style='width:50%;text-align: end;'><b> "+deudaActual+" Gs. </b></td> </tr> </table> "
...
+"<td style='width:80%'><b>PRODUCTO</b></td>"
+"</tr>"
+"</table>"
...
+"<td style='width:30%'>"
+"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr>"
+"<td style='width:45%'><b>TOTAL FACTURA:</b></td> <td style='width:55%;text-align: end;'><b> "+TotalVenta+" Gs. </b></td> </tr> </table> "
+"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr> "
+"<td style='width:45%'><b>TOTAL PAGADO:</b></td> <td style='width:55%;text-align: end;'><b> "+totalpagado+" Gs. </b></td> </tr> </table>"
+"<table class='tableTicket' style='font-size: 15px;font-size: 12px;'> <tr>"
+"<td style='width:45%'><b>SALDO ACTUAL:</b></td> <td style='width:55%;text-align: end;'><b> "+deudaActual+" Gs. </b></td> </tr> </table> "
+"</td>"
+"</tr></table>"
+"</div>"
+"<div class='divSeparadorTicket' style='margin-top:5px;margin-bottom:5px' ></div>"
...
ReImprimirDivTickeFacturaPago(fechaVenta,cajera,CuotasNro,TotalPagado,"0",NombreRecibo,DocumentoRecibo,NroVentas,"","0","",TotalPagado,TotalDescuentoRecibo,totalesRecibo,"0","0","","");	
