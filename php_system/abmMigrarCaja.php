...
$formato=isset($_POST['formato']) ? $_POST['formato'] : '';
	BuscarAbmCajaEscritorio( $user,"Activo",$formato);
...
function BuscarAbmCajaEscritorio( $user,$estado,$formato='')
{
	$mysqli=conectar_al_servidor();
	 $pagina='';
	 $filas=array();
 ...
 if ($valor>0)
 {
	  ...
	  {	  
			  ...
			  $filas[]=array(
				  ...
				  "cod_usuario_recibe" => $cod_usuRecibeFK,
				  "estado" => $estado,
				  "seleccionable" => ($cod_caja_hastaFK=="0" ? "SI" : "NO")
			  );
