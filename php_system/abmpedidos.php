...
$sql= "select pr.cod_persona,concat(pr.nombre_persona,' ',pr.apellido_persona) as nombre_persona,cl.ci_cliente,
...
pro.precio_producto5,pro.precio_producto6,pro.precio_producto9,pro.precio_producto10,pro.precio_producto12,pro.precio_producto15
 ...
 where concat(pr.nombre_persona,' ',pr.apellido_persona,' ',cl.ci_cliente) like ? ";/*Sentencia para buscar registros*/
$pagina = "";   
$buscar="%".$buscar."%";
...
<td style='width: 5%;'><img src='/GoodVentaElectroCasaMaric/iconos/personas.png' class='imgAbmBuscado' /></td>
